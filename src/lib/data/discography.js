export default [
	{
		...
		url: 'coz-i-love-you',
		cover: new URL('$lib/assets/images/covers/coz-i-love-you-cover.jpg', import.meta.url).href
	},
	{
		id: 5,
		release: '2022-08-16',
		...
		desc: {
			zh: '有史以來以飛天章魚視角書寫人類困頓生命的最佳專輯，Super Napkin 自信之作。開場曲「亞熱帶噴射氣流」為搭乘著氣流，旅經各大洲的親身體驗，以搖滾三套件詳實地紀錄。「愛是 Bullet 咖啡烘豆機」是目前已知唯一以咖啡烘豆機視角書寫的情歌，描述嘗試克服社交障礙的思維鍛鍊。「我在想」是一首關於沒想清楚，所以需要一直想，狀似充滿哲理，實際沒有邏輯的獨白。「愛是把武器」把礙事的烏煙瘴氣愛來愛去全都一股腦的吐出去，就像一隻努力不懈的飛天章魚。從飛天章魚熱帶地區級的巨眼看來，人類都在從事「過度補償」的行為，特此寫歌傳頌。這張體現人性的專輯結尾在「丹木斯形狀的心臟」。飛天章魚沒有爬過山，不知道就算要吃藥也要去挑戰高山的人類心態。飛天章魚將其歸納為神秘體驗的一種，和在海底火山旁吃火鍋，是同等的最高境界。',
			en: 'In Super Napkin’s own words, their latest release ‘Subtropical Jet Stream’ is ‘among the Top 80 Octopusgazing albums of all time.’ The album title track ‘Subtropical Jet Stream’ is based on their true experience of riding on a jet stream for a cross-continental trip, and, with dozens of torn speakers, they’ve captured the energy of this unstoppable natural force in this opening track. ‘Love as a Bullet’ is the first known ballad telling human love stories from the angle of a coffee roaster. ‘I’m Thinking’ is a song about all the illogical thoughts and outpouring emotions on an exhausting hiking trip that the narrator didn’t sign up for. ‘Love is a Weapon’ continues to explain this painful hiking trip the narrator didn’t ask for was the direct result of marriage, and it inevitably led to ‘Overcompensation’ in the other aspects of the narrator’s life, such as pedal-hoarding. ‘Diamox Shaped Hearts’ sums it all up through the eyes of the Flying Octopus, questioning human beings’ desire to climb a mountain. To the Flying Octopus, a sea creature, mountains feel like other planets and hiking is not too far from spacewalking. In the song, the Flying Octopus invites the listeners to be in its four pairs of shoes by imagining having a hot pot next to an underwater volcano. '
		},
		note: [
			'Tracking - Jihe Lin',
		...
		cover: new URL('$lib/assets/images/covers/subtropical-jet-stream-cover.jpg', import.meta.url)
			.href
	},
	{
		id: 4,
		...
		desc: {
			zh: '設計師「雪莉」長期在獨立廠牌身兼數職，被 Super Napkin 發現時已呈石化狀態，石像旁聚集數隻野貓，似乎已習於在周遭灑尿。這些「鄰居」個性一隻比一隻差，罄竹難書，只好寫成歌。「麥可的名聲」很好，不過只有熟知他的人才知道他是借錢上癮、欠錢不還的慣犯。「午夜之友」常常在酒吧待到很晚，喝多了就講同一段沒有結果，也沒有如果的單戀。「索妃亞的瑜伽」專練下跪，跪到關節軟韌肌肉精實，以違反貓體工學的教誨，磕頭磕到貓心的黑暗面。「水曜日氣球」是貓群們口述的戀愛傳奇。一隻流浪到羅馬尼亞的玳瑁浪浪，為了流浪而將戀情拋在腦後的故事。「草夠了莓」是都市家貓圈愛講的，關於草莓及貓草夠了沒的雙關笑話。野貓對此嗤之以鼻，開始將都市家貓稱作，「草莓族」。',
			en: 'Super Napkin’s friend and album cover art designer, Sherry, has been petrified due to multitasking for an indie label. Around her statue is a colony of pissed off stray cats nicknamed ‘Neighbors,’ pissing on the stonified designer and each other. ‘Michael’s Credit’ is legendary on the street, but all his closest cats know he’s a debtor who doesn’t pay back. ‘Midnight Friends’ gather at the front doors of the bars around the town every night. Together, they drink the canned beer purchased in the convenience stores to fight the pain of unrequited love and refuse to actually go into the bars. ‘Sofia’s Yoga Lesson’ teaches the male cats how to dogeza properly, like a true dog. ‘Wednesday Balloon’ is an urban legend about a wanderlusting calico who traveled from Taiwan to Romania, falling in love for the first time in her life, but left romance behind for her desire of freedom. ‘Strawberry I Want You’ because strawberries have a chemical profile similar to nepetalactol, the attractant found in catnip. '
		},
		note: [
			'Tracking - Jihe Lin',
			'Mixing - Jihe Lin',
		...
		cover: new URL('$lib/assets/images/covers/sherrys-neighbors-cover.jpg', import.meta.url).href
	},
	{
		id: 3,
		release: '2020-05-11',
		tracks: {
			track1: 'Now I am Getting Stuck into Your Dream',
			track2: 'There’s Nothing That Cannot Beat Me',
			track3: 'Sonic Candy Pepper Blitz',
			track4: 'Nothing’s Wrong It’s Always Wrong',
			track5: 'Diamond Shaped Hearts pt.3 '
		},
		...
		cover: new URL(
			'$lib/assets/images/covers/theres-nothing-that-cannot-beat-me-cover.jpg',
			import.meta.url
		).href
	},
	{
		...
		tracks: {
			track1: 'On Hold',
			track2: 'Diamond Shaped Hearts pt. 1',
			track3: 'Sober Doves',
			track4: 'The Shape',
			track5: 'One Last',
			track6: 'Headless Ghost',
			track7: 'Sold',
			track8: 'Inside Outside',
			track9: 'Diamond Shaped Hearts pt. 2',
			track10: 'Hot Hot Desert'
		},
		...
		note: [
			...
			'Mixing: Yau',
			'Mastering: Brian Elgin',
			'Tracking: Jyun-Ao Caesar / Super Napkin',
			'Graphic Design: Chen Shape / Sherry Chen',
			'Release: Airhead Records X Merdogon Records (2018-05-18)',
			'Special Thanks to I-Cheng Lin'
		],
		url: 'diamond-shaped-hearts',
		cover: new URL('$lib/assets/images/covers/diamond-shaped-hearts-cover.jpg', import.meta.url)
			.href
	},
	{
		id: 1,
		release: '2016-04-08',
		tracks: {
			track1: 'Time To Understand',
			track2: '不重要了',
			track3: 'Brahe',
			track4: 'In Return',
			track5: 'Solid',
			track6: '如果你能接受',
			track7: 'You Found Love Then You Go Silent',
			track8: '八月二十五',
			track9: '沒有防備'
		},
		title: 'Rhythmic Lizard Moon',
		listen: {
			bandcamp: 'https://supernapkin.bandcamp.com/album/rhythmic-lizard-moon',
			soundcloud: 'https://soundcloud.com/super-napkin/sets/rhythmic-lizard-moon-2016'
		},
		bandcamp:
		...
		cover: new URL('$lib/assets/images/covers/rhythmic-lizard-moon-cover.jpg', import.meta.url).href
	}
];
