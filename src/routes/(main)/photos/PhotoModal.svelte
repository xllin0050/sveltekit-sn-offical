...
<div
	id="modal"
	class="relative flex max-h-screen max-w-[92vw] flex-col justify-between rounded-md bg-neutral-50 p-2 uppercase md:p-3"
	transition:scale={modal}
>
	<div class="absolute top-2 right-2 w-6 bg-neutral-50" onclick={onclose} aria-hidden="true">
