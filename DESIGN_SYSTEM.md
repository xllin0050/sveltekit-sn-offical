...
| `--color-surface`        | `#111111` | Secondary background |
| `--color-text-primary`   | `#ffffff` | Main text            |
| `--color-text-secondary` | `#bcbcbc` | Metadata, dates      |
| `--color-accent`         | `#8ca6ff` | Brand accent (blue)  |
| `--color-link`           | `#a6c8ff` | Links, hover         |
...
<div class="space-y-4"> <img class="w-full aspect-square object-cover" /> <h3 class="text-lg font-semibold hover:text-accent transition"> </div> ```
...
Not explainers, no expository paragraphs

Allow ambiguity or mystery
...
This album mixes alternative, pop, and experimental rock influences…
